...
void main() {
	...
	vec3 original_color = texelFetch(colortex0, texel, 0).rgb;
	...
	// Fall back to original color when most samples are out of bounds
	scene_color = weight_sum > 0.5 ? color_sum / weight_sum : original_color;
}
