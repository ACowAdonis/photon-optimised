...
#if defined WORLD_OVERWORLD && defined LATITUDE_SUN_PATH
...
vec3 get_ambient_color() {
...
#else
	vec3 adjusted_sun_dir = sun_dir;
	vec3 adjusted_moon_dir = moon_dir;
#endif
	...
	sky_color = atmosphere_scattering(sky_dir, sun_color, adjusted_sun_dir, moon_color, adjusted_moon_dir, false);
