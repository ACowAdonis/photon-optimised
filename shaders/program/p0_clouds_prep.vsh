...
// Global storm cap value - calculated in main() before calling get_clouds_parameters()
// This must be declared BEFORE including clouds.glsl so it can access the value
float storm_daily_cap = 1.0;
#define STORM_DAILY_CAP_AVAILABLE
...
void main() {
	...
	storm_daily_cap = get_storm_daily_cap(latitude, yearProgress, worldDay, is_snow);
#endif
