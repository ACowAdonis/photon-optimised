...
#endif
	// Generic entities (no special ID) use dedicated mask to avoid terrain material handling
	// This keeps them at default roughness 1.0 (matte) instead of lightness-based smoothness
	if (id == 0u) return 200u;
	return id;
